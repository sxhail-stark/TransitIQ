...
def get_url():
    return os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/transitiq")
...
def run_migrations_offline() -> None:
    ...
    Calls to context.execute() here will emit the given string to the script output.
    """
    url = get_url()
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    ...
    # Check if mysql in url, configure pool recycle
